    ...
    <script type="text/javascript">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-5 col-md-2"> Bienvenue <br> <a href="M_utilisateur/profile.php"><?php echo $user->getPrenom()." ".$user->getNom()?><a></a><br> <select><option name="francais">Francais</option> <option name="anglais">English</option></select>  </div>
        ...
        <ul class="breadcrumbs col_6">
				<li>
					<a href="../accueilAdmin.php">Acceil</a>
				</li>
				<li>
					<a href="../accueilAdmin.php">Oxfam/Projet</a>
				</li>
