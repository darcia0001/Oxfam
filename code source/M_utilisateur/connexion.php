                ...
                <div class="col_6">
                    ...
                    <div class="alert alert-danger alert-dismissable col-md-6 col-md-offset-3"
                        ...
                        <button type="button"
                                ...
                                aria-hidden="true">×</button>
                                         Le mot de passe entré n'est pas correct. Veuillez essayer encore.
                    </div>
                    <?php
                    ...
                    <div class="alert alert-danger alert-dismissable col-md-6 col-md-offset-3"
                         align="center"><button type="button"
                                                ...
                                                data-dismiss="alert"
                                                aria-hidden="true">×</button>
                                     Votre compte n'est pas encore activé par un administrateur. Veuillez patienter le tant qu'un administrateur l'approve. Merci.
                    </div>
                    <?php
