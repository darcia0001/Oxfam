      ...
      <script type="text/javascript">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-5 col-md-2"> Bienvenue <br> <a href="profile.php"><?php echo $user->getPrenom()." ".$user->getNom()?></a><br> <select><option name="francais">Francais</option> <option name="anglais">English</option></select>  </div>
